...
#
#     PHX_SERVER=true bin/hex_empire start
#
# Alternatively, you can use `mix phx.gen.release` to generate a `bin/server`
# script that automatically sets the env var above.
if System.get_env("PHX_SERVER") do
  config :hex_empire, HexEmpireWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :hex_empire, :dns_cluster_query, System.get_env("DNS_CLUSTER_QUERY")

  # Where GameStore mirrors campaigns to disk. Without this the fallback is a
